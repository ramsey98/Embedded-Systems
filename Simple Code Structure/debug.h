...
#define BEFORE_RECEIVE_QUEUE (0b00000100)
#define AFTER_SEND_QUEUE (0b00000101)
#define AFTER_RECEIVE_QUEUE (0b00000110)
#define ENTER_ISR (0b00000111)
#define LEAVE_ISR (0b00001000)
#define BEFORE_SEND_QUEUE_ISR (0b00001001)
#define BEFORE_RECEIVE_QUEUE_ISR (0b00001010)
#define AFTER_SEND_QUEUE_ISR (0b00001011)
